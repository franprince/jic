...
export default function Form({ sent, setSent, size }) {
  const options1 = [
    ...
    {
      value: "Otro",
      label: "Ni idea, ayudame a decidir 🙏",
      category: "1",
    },
  ];
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className={styles.select}>
          <Select
            ...
            name="producto"
            styles={customStyles}
            placeholder="Estoy necesitando"
          />
          <p
            style={missingProduct ? { display: "block" } : { display: "none" }}
          >
        ...
        <div className={styles.select}>
          <Select
            ...
            name="presupuesto"
            styles={customStyles}
            placeholder="Mi presupuesto estimado es"
          />
          <p style={missingBudget ? { display: "block" } : { display: "none" }}>
            Por favor, completá este campo.
          </p>
        </div>
        <p>
